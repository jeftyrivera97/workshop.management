import { GastoAnalisisMensual } from "../../../../interfaces";
...
export const AnalisisFinanciero = ({
  ...
  const getCategoryEmoji = (categoria: string) => {
    switch (categoria) {
      case "gastos_fijos":
        return "🏠"; // Casa = gastos fijos/estables
      case "gastos_variables":
        return "📊"; // Gráfico = variables/fluctuaciones
      case "gastos_directos":
        return "🎯"; // Diana = directo al objetivo
      case "gastos_indirectos":
        return "🔄"; // Ciclo = indirecto/circular
      case "gastos_extraordinarios":
        return "⚡"; // Rayo = extraordinario/inesperado
      default:
        return "📈";
    }
  };
      ...
      <div className="card bg-gradient-to-r from-base-100 to-base-200 shadow-lg">
        <div className="card-body p-4">
          <h2 className="card-title text-xl font-bold flex items-center gap-2">
            📊 Análisis por Tipos de Gastos
            <div className="badge badge-primary">{selectedMonthName}</div>
          </h2>
          <p className="text-sm opacity-70">
            Análisis detallado de las compras del mes seleccionado. Cada tarjeta
            representa un análisis financiero clave, con recomendaciones y
            estado actual.
          </p>
        </div>
      </div>
