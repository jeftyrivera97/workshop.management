...
export const GastoIndex = () => {
  ...
  useEffect(() => {
    if (!hasLoadedRef.current) {
      startLoading(1, "gasto", currentSelectedMonth);
  ...
  const handleMonthSelection = (selectedMonth: string) => {
    ...
    startLoading(1, "gasto", selectedMonth);
  };
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-6">
        ...
        <DataTable
          data={tiposMes}
          titulo={`Gastos por Tipo - ${selectedMonthName}`}
        />
        <DataTable
          data={categoriasMes}
          titulo={`Gastos por Categoría - ${selectedMonthName}`}
        />
