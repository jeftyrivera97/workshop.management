...
export const SideBarItem = ({ onNavigate }: { onNavigate: () => void }) => {
  return (
    <>
      <li ><Link to="/home" onClick={onNavigate}><p className="menuItems">Anual</p></Link></li> &nbsp;
      ...
      <li ><Link to="/planillas" onClick={onNavigate}><p className="menuItems">Planillas</p></Link></li>&nbsp;
       <li ><Link to="/servicios" onClick={onNavigate}><p className="menuItems">Servicios</p></Link></li>&nbsp;
    </>
  )
}
